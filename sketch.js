...
function setup(){
    ...
    var rotator_options={
     ...
     rotator2 = rectangle(250,200,150,20,rotator_options);
     World.add(world,rotator2);

     rotator2 = Bodies.rectangle();
     World.add(world,rotator2);

     rotator2 = Bodies.circle(250,200,150,20,rotator_options);
     World.add(world,rotator2);

     rotator2 = Bodies.rectangle(250,200,150,20,rotator_options);
     World.add(world,rotator2);

     rotator3 = rectangle(250,200,150,20,rotator_options);
     World.add(world,rotator3);

     rotator3 = Bodies.rectangle();
     World.add(world,rotator3);

     rotator3 = Bodies.circle(250,200,150,20,rotator_options);
     World.add(world,rotator3);
